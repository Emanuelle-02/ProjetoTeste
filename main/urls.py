...
urlpatterns = [
    ...
    path('graph_despesas_mensal', views.graph_despesas_mensal, name="graph_despesas_mensal"),
    path('graph_despesas_anual', views.graph_despesas_anual, name="graph_despesas_anual"),
